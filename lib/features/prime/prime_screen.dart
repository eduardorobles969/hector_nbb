                ...
                child: ListView(
                  children: const [
                    _PrimeBenefit(
                      ...
                      description: 'Desbloquea entrenamientos exclusivos y planificados para cada objetivo.',
                    ),
                    _PrimeBenefit(
                      title: 'Acompañamiento personal',
                      description: 'Conversa con tu coach para ajustar tu programa en tiempo real.',
                    ),
                    _PrimeBenefit(
                      title: 'Seguimiento avanzado',
                      description: 'Lleva el control detallado de tu progreso y métricas clave.',
                    ),
                    _PrimeBenefit(
                      title: 'Actualizaciones semanales',
                      description: 'Recibe nuevos retos y contenidos cada semana para mantener la motivación.',
                    ),
                  ],
                ),
              ),
